function render(elm, container) {
    ...
    for (let attribute in elm.props.attributes)
        element.setAttribute(attribute, elm.props.attributes[attribute]);
...
function Header() {
    return Miku.createElement("div", null,
        ...
        Miku.createElement("ul", null,
            ...
            Miku.createElement("li", null, "Spring and Autumn Garden Parties"),
